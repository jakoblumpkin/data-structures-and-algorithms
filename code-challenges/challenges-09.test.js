...
function transformToLis(obj){
  ...
  console.log(obj2);
  let newObj=obj2.reduce( (thearr, value) => {
    thearr.push('<li>'+value[0]+': '+value[1]+'</liv>');
    return thearr;
  }, []);
  return newObj;
}
...
const addValues = (arr) => {
  let newObj=arr.reduce( (thearr, i) => {
    thearr.push(i);
    return thearr;
  }, []);
  return newObj;
...
const addPurchases = (arr) => {
  let newObj=arr.reduce( (thearr, value) => {
    thearr=thearr+value['purchasePrice'];
    return thearr;
  }, 0);
  return newObj;
};
...
const reversedString = (str) => {
  ...
  let theLen=mylist.length-1;
  mylist.reduce( (thearr, i) => {
    Newlist.push(mylist[thearr]);
    return thearr=thearr-1;
  }, theLen);
  return Newlist;
};
...
const countNumberOfChildren = (arr) => {
  let names=arr.reduce( (thearr, i) => {
    if(i.children){
      thearr=thearr+i.children.length;
    }
    return thearr;
  }, 0);
  return names;
